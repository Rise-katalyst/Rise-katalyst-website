...
const heroCaps = [
  ...
  { label: "Funnels", value: "Admission-led" },
  { label: "Creative", value: "Performance-first" },
  { label: "Execution", value: "Measured weekly" },
];
  ...
  return (
    <div className="site-shell">
      <div className="site-bg" aria-hidden="true">
        ...
        <div className="bg-runner bg-runner-a" />
        <div className="bg-runner bg-runner-b" />
        <div className="bg-runner bg-runner-c" />
      </div>
      ...
      <div className="hero-visual-shell">
        <div className="marquee-strip top">
          <div className="marquee-track">
            {loop.map((item, index) => (
              <span key={`top-${index}`} className="marquee-item">{item}</span>
            ))}
          </div>
        </div>
        ...
        <div className="hero-stage">
          ...
          <div className="hero-stage-center">
            <img src="/logo-mark.png" alt="Katalyst Rise mark" className="hero-stage-logo" />
          </div>

          <div className="hero-stage-grid">
            {heroCaps.map((item, index) => (
              <div key={item.label} className={`hero-stage-card float-${(index % 4) + 1}`}>
                <p>{item.label}</p>
                <h4>{item.value}</h4>
              </div>
            ))}
        ...
        <div className="marquee-strip bottom">
          <div className="marquee-track reverse">
            {loop.map((item, index) => (
              <span key={`bottom-${index}`} className="marquee-item">{item}</span>
            ))}
          </div>
        </div>
      </div>
